			...
			<div className={styles.home}>
				<div className={styles.left}>
					...
					<div className={styles.words}>
						The "self" thing is invisible. When you bump into something else and bounce back, you will
						understand "self". So, collide with very strong things, terrible things, and high-level things,
						and then only know what "self" is.
						<br />
